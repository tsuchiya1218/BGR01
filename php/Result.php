                    ...
                    <div class="list2">
                        ...
                        <div class="bi">
                            ...
                            ?>
                                    <div class="tab">
                                        <!--b_code=name-->
                                        <a href="addCart.php?b_code=<?= $value['b_code'] ?>&price=<?= $value['b_purchaseprice'] ?>&cart=reservecart">購入</a>
                            ...
                            ?>
                                <div class="tab">
                                    <!--b_code=name-->
                                    <a href="addCart.php?b_code=<?= $value['b_code'] ?>&price=<?= $value['b_rentalprice'] ?>&cart=rentalcart">レンタル</a>
